...
//           <div
//             key={player.name}
//             className="flex items-center gap-3 p-3 bg-primary rounded-lg table-row-hover cursor-pointer transition-all duration-300"
//             onMouseEnter={() => setHoveredPlayer(`${title}-${player.name}`)}
//             onMouseLeave={() => setHoveredPlayer(null)}
//             style={{ animationDelay: `${index * 0.1}s` }}
//           >
//             <span className={`w-7 h-7 rounded-full flex items-center justify-center text-xs font-bold ${
//               player.rank === 1 ? 'bg-accent text-primary' :
//               player.rank === 2 ? 'bg-yellow-500 text-primary' :
//               player.rank === 3 ? 'bg-orange-500 text-primary' :
...
//               <p className="text-xs text-text-muted">{player.team} • {player.matches} matches</p>
//             </div>
            
//             <div className="text-right">
//               <p className="text-xl font-bold text-accent number-roll">{player[statKey]}</p>
//               <p className="text-xs text-text-muted">{statLabel}</p>
//             </div>

//             {/* Tooltip */}
//             {hoveredPlayer === `${title}-${player.name}` && (
//               <div className="absolute right-0 top-full mt-2 z-10 bg-primary border border-border rounded-lg p-3 shadow-xl animate-fade-in">
//                 <p className="font-medium text-white text-sm">{player.name}</p>
//                 <div className="grid grid-cols-2 gap-2 mt-2 text-xs">
//                   <div>
//                     <span className="text-text-muted">Avg:</span>
//                     <span className="text-white ml-1">{player.average || '-'}</span>
//                   </div>
//                   <div>
//                     <span className="text-text-muted">SR:</span>
//                     <span className="text-white ml-1">{player.strikeRate || '-'}</span>
//                   </div>
//                   {player.highest && (
//                     <div>
//                       <span className="text-text-muted">HS:</span>
//                       <span className="text-white ml-1">{player.highest}</span>
//                     </div>
//                   )}
//                   {player.best && (
//                     <div>
//                       <span className="text-text-muted">BB:</span>
//                       <span className="text-white ml-1">{player.best}</span>
//                     </div>
//                   )}
//                 </div>
//               </div>
...
//   return (
//     <section id="stats" className="py-4 px-4 sm:px-6 lg:px-8">
//       <div className="w-full">
//         {/* Section Header */}
//         <div className="text-center mb-10 animate-slide-up">
//           <h2 className="text-2xl md:text-3xl font-bold text-white mb-2">
//             Leading <span className="text-accent">Players</span>
//           </h2>
//           <p className="text-text-muted">Top performers of the season</p>
//         </div>
...
//           <button className="px-6 py-3 bg-accent/10 text-accent rounded-lg hover:bg-accent/20 transition-colors font-medium">
