...
//         isAuthPage
//           ? 'relative bg-transparent' // 🔥 scrollable header
//           : isScrolled
//           ? 'fixed bg-primary/90 backdrop-blur-lg border-b border-border'
...
//                 className="hidden sm:flex items-center gap-2 px-4 py-2 bg-accent/10 text-accent rounded-lg hover:bg-accent/20"
//               >
//                 <User size={18} />
